...
const PocketAdv = ({ path, content }: TProps) => {
  return (
    <div className="shadow-md shadow-[#E5E5E5] rounded-bl-[10px] rounded-br-[10px] flex flex-col items-center w-[118px] h-[118px] pt-[21px] px-[21px] border-[1px] border-t-0">
